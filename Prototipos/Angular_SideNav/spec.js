...
describe('Teste com Side Nav Angular', function() {
    ...
    beforeEach(function() {
        browser.get('http://127.0.0.1:52838/Prototipos/Angular_SideNav/mat.html#/elementos');
    });
    ...
    it('Checkin / Checkout', function() {
        ...
        //var pega_h4_2 = pega_um_elemento.all(filtra_h4).get(1); // pega o 2 h4
        //var pega_h4_3 = pega_um_elemento.all(filtra_h4).get(2); // pega o 3 h4
        ...
        //var pega_botao_2 = pega_um_elemento.all(filtra_botoes).get(1);
        //var pega_botao_3 = pega_um_elemento.all(filtra_botoes).get(2); // pega botoes

        pega_botao.click();
        //pega_botao_2.click();
        //pega_botao_3.click();

        var class_elemento_disponibilidade_depois = pega_h4.getAttribute('class'); //Pega Class h4 - (desocupado ou ocupado);
