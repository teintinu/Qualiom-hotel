...
window.addEventListener('load', function() {
    declara_conjunto_teste('testHello', 'http://localhost:8080/fw/hello.html');
    declara_conjunto_teste('testHello2', 'http://localhost:8080/fw/hello.html');
    declara_conjunto_teste('testTestador', 'http://localhost:8080/qtest/qtest2.html');
    declara_conjunto_teste('testHotel1', 'http://localhost:8080/../Prototipos/Angular_SideNav/mat.html#/elementos');
    declara_conjunto_teste('testHotel2', 'http://localhost:8080/Prototipos/Angular_SideNav/mat.html#/elementos');
});
